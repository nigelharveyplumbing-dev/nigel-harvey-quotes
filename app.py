...
APP_VERSION = "16.3.10-guildford-blue-design"
...
BANK_ACCOUNT_NAME = (os.getenv("BANK_ACCOUNT_NAME") or "NIGEL HARVEY LTD").strip()
BANK_SORT_CODE = (os.getenv("BANK_SORT_CODE") or "04-00-04").strip()
BANK_ACCOUNT_NUMBER = (os.getenv("BANK_ACCOUNT_NUMBER") or "23669594").strip()
SHOW_BANK_DETAILS_ON_QUOTES = (os.getenv("SHOW_BANK_DETAILS_ON_QUOTES") or "1").strip() == "1"
AUTO_OVERDUE_REMINDERS = (os.getenv("AUTO_OVERDUE_REMINDERS") or "0").strip() == "1"
OVERDUE_REMINDER_INTERVAL_HOURS = max(1, int((os.getenv("OVERDUE_REMINDER_INTERVAL_HOURS") or "24").strip() or "24"))
...
<section class="guildford-hero"><div class="wrap"><div class="hero-copy"><div class="eyebrow">Nigel Harvey Plumbing · Guildford</div><h1>Plumber in Guildford</h1><p>Local domestic plumbing for leaks, taps, toilets, bathrooms, showers, radiators and pipework. From first enquiry to finished job, you deal directly with Nigel.</p><div class="actions"><a class="btn" href="/request-quote">Get a Quote</a><a class="btn white" href="tel:{escape(COMPANY_PHONE_TEL)}">Call {escape(COMPANY_PHONE)}</a></div></div></div></section>
